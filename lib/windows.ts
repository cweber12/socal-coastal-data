...
export const STATE_PRESENTATION: Readonly<Record<WindowState, StatePresentation>> = {
  go: { label: 'Go', spoken: 'go', glyph: '●', colorVar: 'var(--color-state-go)', usable: true },
  brief: {
    label: 'Brief',
    spoken: 'brief',
    glyph: '◐',
    colorVar: 'var(--color-state-brief)',
    usable: false,
  },
  veto: {
    label: 'Swell',
    spoken: 'vetoed on swell',
    glyph: '✕',
    colorVar: 'var(--color-state-veto)',
    usable: false,
  },
  dark: {
    label: 'No light',
    spoken: 'outside daylight',
    glyph: '☾',
    colorVar: 'var(--color-state-dark)',
    usable: false,
  },
  'above-floor': {
  ...
  'swell-tbd': {
    label: 'Swell TBD',
    spoken: 'swell unknown',
    glyph: '?',
    colorVar: 'var(--color-state-swell-tbd)',
    usable: false,
  },
};
